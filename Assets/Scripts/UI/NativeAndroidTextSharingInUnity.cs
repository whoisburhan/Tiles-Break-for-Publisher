...
public class NativeAndroidTextSharingInUnity : MonoBehaviour
{
    ...
    public IEnumerator ShareTextInAnroid()
    {
        ...
        var shareSubject = "Tiles Break - Be Fast";
        var shareMessage = "Best Way of spending bored time...  Download Now \n" +
                           "https://play.google.com/store/apps/details?id=com.GameSeekersStudio.TilesBreak";
